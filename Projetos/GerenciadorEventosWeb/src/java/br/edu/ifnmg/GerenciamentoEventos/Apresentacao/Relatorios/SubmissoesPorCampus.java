 ...
 * @author petronio
 */
@Named(value = "submissoesPorCampusController")
@RequestScoped
public class SubmissoesPorCampus
        extends ControllerBaseRelatorio<Campus>
        implements Serializable {

    /**
     * Creates a new instance of FuncionarioBean
     */
    public SubmissoesPorCampus() {
        setArquivoSaida("SubmissoesPorCampus");
        setRelatorio("SubmissoesPorCampus.jasper");
    }
    ...
    protected Map<String, Object> carregaParametros() {
        try {
            ...
            Logger.getLogger(SubmissoesPorCampus.class.getName()).log(Level.SEVERE, null, ex);
            return new HashMap<>();
        }
    }
