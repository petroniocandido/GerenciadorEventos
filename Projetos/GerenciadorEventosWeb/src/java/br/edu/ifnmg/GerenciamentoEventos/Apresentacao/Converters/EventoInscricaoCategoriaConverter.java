 ...
 * @author petronio
 */
@Named(value = "eventoInscricaoCategoriaConverter")
@Singleton
public class EventoInscricaoCategoriaConverter
        extends GenericConverter<EventoInscricaoCategoria, EventoInscricaoCategoriaRepositorio>
    ...
    public void init() {
     ...
     public List<EventoInscricaoCategoria> autoComplete(String query) {
        EventoInscricaoCategoria i = new EventoInscricaoCategoria();
        i.setNome(query);
        return dao.Buscar(i);
    }
}
