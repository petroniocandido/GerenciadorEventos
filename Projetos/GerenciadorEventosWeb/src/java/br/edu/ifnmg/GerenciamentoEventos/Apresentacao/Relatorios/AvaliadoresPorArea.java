 ...
 * @author petronio
 */
@Named(value = "avaliadoresPorAreaController")
@RequestScoped
public class AvaliadoresPorArea
     ...
     */
    public AvaliadoresPorArea() {
        setArquivoSaida("AvaliadoresPorArea");
    ...
    protected Map<String, Object> carregaParametros() {
        try {
            ...
            tmp.put("titulo", "Avaliadores Por Área");
            return tmp;
        } catch (MalformedURLException ex) {
            Logger.getLogger(AvaliadoresPorArea.class.getName()).log(Level.SEVERE, null, ex);
            return new HashMap<>();
        }
    }
    ...
    public Collection<AreaConhecimento> getDados() {
        ...
        Collection<AreaConhecimento> tmp = dao.AvaliadoresPorAreas(
                daoP.Abrir( Long.parseLong( getConfiguracao("PERFILSELECAOAVALIADOR") ) ));
